...
public class NPCData : MonoBehaviour//, IDataPersistence
{
    ...
    [Header("StaminaGive Check")]
    public bool Marin_staminaIncreased;
    public bool Alice_staminaIncreased;
    public bool Alex_staminaIncreased;
    public bool Old_Man_staminaIncreased;
    ...
    {
        this.Marin_current_relationship = data.MarinRelation;
        this.Alice_current_relationship = data.AliceRelation;
        this.Alice_current_relationship = data.AlexRelation;
        this.Old_Man_current_relationship = data.OldManRelation;
    }

    public void SaveData(ref GameData data)
    {
        data.MarinRelation = this.Marin_current_relationship;
        data.AlexRelation = this.Alice_current_relationship;
        data.AlexRelation= this.Alex_current_relationship;
        data.OldManRelation = this.Old_Man_current_relationship;
    }*/
    ...
    void IncreaseStaminaForAllNPCs()
    {
        if (uiManager != null)
        {
            if (Marin_stamina == true && !Marin_staminaIncreased)
            {
                uiManager.IncreaseMaxStamina(25);
                Marin_staminaIncreased = true;
            }

            if (Alice_stamina == true && !Alice_staminaIncreased)
            {
                uiManager.IncreaseMaxStamina(25);
                Alice_staminaIncreased = true;
            }

            if (Alex_stamina == true && !Alex_staminaIncreased)
            {
                uiManager.IncreaseMaxStamina(25);
                Alex_staminaIncreased = true;
            }

            if (Old_Man_stamina == true && !Old_Man_staminaIncreased)
            {
                uiManager.IncreaseMaxStamina(25);
                Old_Man_staminaIncreased = true;
            }
        }
        else
        {
